...
export class OrderComponent implements OnInit {
  ...
  constructor(
    ...
    this.orderForm = this.formBuilder.group({
      fullname: ['yasrn', Validators.required], // fullname là FormControl bắt buộc      
      email: ['yasrn@gmail.com', [Validators.email]], // Sử dụng Validators.email cho kiểm tra định dạng email
      phone_number: ['0968698102', [Validators.required, Validators.minLength(6)]], // phone_number bắt buộc và ít nhất 6 ký tự
      address: ['Ha Noi', [Validators.required, Validators.minLength(5)]], // address bắt buộc và ít nhất 5 ký tự
      note: ['No'],
